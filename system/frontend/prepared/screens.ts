...
export const screensSchema: ScreensSchema = {
  ...
  "system_MailAccountsScreen": {
    "name": "system_MailAccountsScreen",
    "rootComponentPath": "system/containers/MailAccounts",
    "rootComponent": React.lazy(() => import('system/containers/MailAccounts')),
    "requires": [
      "system.admin_mail"
    ],
    "routeUrl": "/settings/system/mail/accounts",
    "routeParams": [],
    "params": {}
  },
  "reserve_ReservationsActuals": {
    "name": "reserve_ReservationsActuals",
    "rootComponentPath": "reserve/frontend/containers/ReservationsActuals",
    "rootComponent": React.lazy(() => import('reserve/frontend/containers/ReservationsActuals')),
    "requires": [
  ...
  "reserve_ReservationsHistory": {
    ...
    "rootComponentPath": "reserve/frontend/containers/ReservationsHistory",
    "rootComponent": React.lazy(() => import('reserve/frontend/containers/ReservationsHistory')),
    "requires": [
  ...
  "services_ReservationsActuals": {
    ...
    "rootComponentPath": "services/frontend/containers/Services",
    "rootComponent": React.lazy(() => import('services/frontend/containers/Services')),
    "requires": [
      "services.manage"
    ],
