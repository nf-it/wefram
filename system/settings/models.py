...
class SettingsCatalog(UserDict):
    def __init__(self, entity: entities.SettingsEntity, user_id: Optional[str]):
        super().__init__()
        ...
        self.entity: entities.SettingsEntity = entity
    ...
    def __getitem__(self, key):
        ...
        prop: props.PropBase = self.entity.properties[key]
        if isinstance(prop, props.ImageProp):
            return ds.StoredImage(prop.entity, item)
        elif isinstance(prop, props.FileProp):
            return ds.StoredFile(prop.entity, item)
        return item
